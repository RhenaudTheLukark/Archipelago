...
class LocationCategory(IntEnum):
    ...
    TRAINERSANITY = 16
    FAMESANITY = 17
    FAMESANITY_POKEMON_REQUEST = 18
    DEXSANITY = 19
    EVENT = 20
    EVENT_WILD_POKEMON = 21
    EVENT_STATIC_POKEMON = 22
    EVENT_LEGENDARY_POKEMON = 23
    EVENT_EVOLUTION_POKEMON = 24
    EVENT_TRAINER_SCALING = 25
    EVENT_WILD_POKEMON_SCALING = 26
    EVENT_STATIC_POKEMON_SCALING = 27
